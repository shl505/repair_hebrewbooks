        ...
        if string and repaired_text.find(string) >= 0:
            ...
            for i in range(number):
                ...
                if "pagefeed/hebrewbooks_org" in parts:
                    ...
                    if not "http://www.hebrewbooks.org/rambam" or "http://www.hebrewbooks.org/root" or "http://www.hebrewbooks.org/shas" in parts:
                    ...
                    if not "http://hebrewbooks.org/rambam" or "http://hebrewbooks.org/root" or "http://hebrewbooks.org/shas" in parts:
